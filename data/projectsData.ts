const ProjectsData = [
  {
    ...
    description: `I presented a walkthrough of the d3-random module of the popular JavaScript data-visualization library. This was a talk with the Bay Area d3 meetup group in 2018.`,
    imgSrc: '/static/images/d3-random-talk.png',
    href: 'https://www.youtube.com/watch?v=Fb1za8ZWhYw',
  },
  {
