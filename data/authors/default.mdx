...
I'm a software and machine-learning engineer based in the San Francisco Bay Area. I currently work for [xD](https://www.xd.gov/), a small team within the [United States Census Bureau](https://www.census.gov/) focused on using new and emerging technologies to improve government services. I am also a volunteer contributor for [OpenMined](https://www.openmined.org/), where I support open-source tools to enable privacy-preserving machine learning and data science.
