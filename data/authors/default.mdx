...
I'm a software engineer based in the San Francisco Bay Area. I focus on privacy and machine learning applications, and I currently work for [xD](https://www.xd.gov/), a small team within the [United States Census Bureau](https://www.census.gov/) that uses new and emerging technologies to improve government services. I have also contributed to several open-source projects, especially with the group [OpenMined](https://www.openmined.org/).
