...
This is my personal blog built on top of an awesome [template](https://github.com/timlrx/tailwind-nextjs-starter-blog) created by [Timothy Lin](https://github.com/timlrx). I write about topics ranging from mathematics and AI to web development and general topics about a career in software development and machine learning.
